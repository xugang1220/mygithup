...
<script src="js/yfyue.init.js" type="text/javascript"></script>
...
<script src="js/yfyue_bjui_pagin.js"></script>
<script src="js/yfyue.js"></script>
<link href="css/yfyue.css" rel="stylesheet">
<!-- init -->
<script type="text/javascript">
$(function () {
	yfyueLoadInitData('<%=SetSys.loadInitData()%>');				
    BJUI.init({
        JSPATH       : 'BJUI/',         //[可选]框架路径
...
/*验证是否SESSION失效*/
$(function () {	
	LoginAjax.getLoginUserName(null, function (data) {
		data = fjson(data);
		if (data.state == 0) {
			$("#frameUserName").html(ifNull(data.object));
			//生成导航
		} else {
...
<body>
<!--[if lte IE 7]>
        <div id="errorie"><div>您IE浏览器版本过低，正常使用系统前请升级您的浏览器到 IE8以上版本 <a target="_blank" href="http://windows.microsoft.com/zh-cn/internet-explorer/ie-8-worldwide-languages">点击升级</a>&nbsp;&nbsp;强烈建议您更改换浏览器：<a href="http://down.tech.sina.com.cn/content/40975.html" target="_blank">谷歌 Chrome</a></div></div>
    <![endif]-->
<div id="bjui-window">
  <header id="bjui-header">
    <div class="bjui-navbar-header">
      ...
      <a class="bjui-navbar-logo" href="javascript:;"><img src="images/logo.png"></a> </div>
    <nav id="bjui-navbar-collapse">
      ...
      <li><a href="javascript:;"><span id="frameUserName" class="badge"></span></a></li>
        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">我的账户 <span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
            <li><a href="page/sys/myInfo/changeMyPasswd.jsp" data-toggle="dialog" data-id="changMyPasswd_z_160818_1100" data-mask="true" data-width="450" data-height="300">&nbsp;<span class="glyphicon glyphicon-lock"></span> 修改密码&nbsp;</a></li>
            <li><a href="page/sys/myInfo/myInfo.jsp" data-toggle="dialog" data-id="myInfo_z_160818_1100" data-mask="true" data-width="600" data-height="300">&nbsp;<span class="glyphicon glyphicon-user"></span> 我的资料</a></li>
             <li><a href="page/sys/myInfo/opLog.jsp" data-fresh="true" data-toggle="navtab" data-id="userLog_z_160818_1100">&nbsp;<span class="glyphicon glyphicon-list-alt"></span> 操作日志</a></li>
            <li class="divider"></li>
            <li><a href="javascript:;" onClick="exitSys();" class="red">&nbsp;<span class="glyphicon glyphicon-off"></span> 注销登录</a></li>
          </ul>
        </li>
        <li class="dropdown"><a href="javascript:;" class="dropdown-toggle theme blue" data-toggle="dropdown" title="切换皮肤"><i class="fa fa-tree"></i></a>
    ...
    <div id="bjui-hnav">
      ...
      <div id="bjui-hnav-navbar-box">
        ...
        <!--功能开始-->
        <sys:SysTag>funcList</sys:SysTag>
<!--
            ...
            <div class="items hide" data-noinit="true">
              <ul id="bjui-hnav-tree2" class="ztree ztree_main" data-toggle="ztree" data-on-click="MainMenuClick" data-expand-all="true" data-faicon="table">
                ...
                <li data-id="3" data-pid="0" data-faicon="bullhorn" data-faicon-close="folder-o">个人中心</li>
                <li data-id="16" data-pid="3" data-url="page/notify/readerNotifyList.jsp" data-tabid="16" data-faicon="hand-o-up">个人信息</li>
                <li data-id="17" data-pid="3" data-url="page/notify/notifyList.jsp" data-tabid="17" data-faicon="calendar-o">账户日志</li>
                <li data-id="17" data-pid="3" data-url="page/notify/notifyList.jsp" data-tabid="17" data-faicon="calendar-o">密码修改</li>                
                <li data-id="4" data-pid="0" data-faicon="cog" data-faicon-close="folder-o">系统设置</li>
                <li data-id="deve18" data-pid="4" data-url="page/sys/user/userList.jsp" data-tabid="deve18" data-faicon="flag">帐户管理</li>
                <li data-id="18" data-pid="4" data-url="page/sys/func/funcList.jsp" data-tabid="18" data-faicon="flag">功能管理</li>

                <li data-id="19" data-pid="4" data-url="page/sys/area/areaList.jsp" data-tabid="19" data-faicon="institution">地区管理</li>
                <li data-id="20" data-pid="4" data-url="page/sys/orge/orgeList.jsp" data-tabid="20" data-faicon="user-secret">部门管理</li>
           <li data-id="280" data-pid="4" data-url="page/sys/role/roleList.jsp" data-tabid="280" data-faicon="user-secret">角色管理</li>             
               <li data-id="333" data-pid="4" data-url="page/sys/orge/orgeList.jsp" data-tabid="333" data-faicon="user-secret">数据字典</li>
               <li data-id="444" data-pid="333" data-url="page/sys/init/initType.jsp" data-tabid="444" data-faicon="user-secret">配置类型</li>
               <li data-id="555" data-pid="333" data-url="page/sys/init/initData.jsp" data-tabid="555" data-faicon="user-secret">配置数据</li>
              </ul>
            </div>
          </li>
        -->
      ...
      <div class="tabsPageHeader">
        <div class="tabsPageHeaderContent">
          <ul class="navtab-tab nav nav-tabs">
            <li data-url="welcome.jsp"><a href="javascript:;"><span><i class="fa fa-home"></i>#maintab#</span></a></li>
          </ul>
        </div>
  ...
  <footer id="bjui-footer"> 版权所有Copyright &copy; <%=SetSys.companyName%> <%=SetSys.technicalSupport%>　 </footer>
</div>
</body>
</html>